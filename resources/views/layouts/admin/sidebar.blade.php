<nav id="sidebar">
    ...
    <div class="sidebar-header">
        <div class="logo_section">
            <a href="index.html"><img class="logo_icon img-responsive" src="{{ asset('import/images/logo/logo_icon.png') }}" alt="#" /></a>
        </div>
    </div>
    <div class="sidebar_user_info">
        <div class="icon_setting"></div>
        <div class="user_profle_side">
            <div class="user_img"><img class="img-responsive" src="{{ asset('import/images/layout_img/user_img.jpg') }}" alt="#" /></div>
            <div class="user_info">
    ...
    <ul class="list-unstyled components">
        <li class="active">
            ...
            <ul class="collapse list-unstyled" id="dashboard">
                <li>
                <a href="{{route("homepage")}}">> <span>Default Dashboard</span></a>
                </li>
                {{-- <li>
