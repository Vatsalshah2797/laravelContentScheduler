                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-12">
                           <div class="full dis_flex center_text">
                              <div class="profile_img"><img width="180" class="rounded-circle" src="{{ asset('import/images/layout_img/user_img.jpg') }}" alt="#" /></div>
                              <div class="profile_contant">
                                 <div class="contact_inner">
                                    <h3>{{ucwords($user->name) ?? ''}}</h3>
                                    <p><strong>About: </strong>Fullstack Developer</p>
